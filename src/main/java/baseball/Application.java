...
public class Application {
    ...
    public static final int INPUT_FIRST = pickNumberInRange(1, 9);
    public static final int INPUT_SECOND = pickNumberInRange(1, 9);
    public static final int INPUT_THIRD = pickNumberInRange(1, 9);
